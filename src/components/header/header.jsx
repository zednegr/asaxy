                        ...
                        <div className="icons">
                            <div className="icon">
                                <svg className='icon-svg' width="33" height="24" viewBox="0 0 33 24" fill="#0059a1" xmlns="http://www.w3.org/2000/svg">
                                    <g id="payment.svg" clipPath="url(#clip0_3_2836)">
                                        <g id="Layer_x0020_1">
                                            <g id="_1735475502800">
                            ...
                            <div className="icon" onClick={(evt) => {
                                ...
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="cart.svg" clipPath="url(#clip0_3_2856)">
                                        <g id="Layer_x0020_1">
                                            <g id="_1732897426368">
                            ...
                            <div className="icon" onClick={(evt) => {
                                ...
                                <svg className="cabinet" width="18" height="24" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="avatar.svg" clipPath="url(#clip0_3_2875)">
                                        <g id="Layer_x0020_1">
                                            <g id="_1732704023632">
